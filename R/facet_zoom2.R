#' facet_zoom2
#'
#' @description Alternative function to ggcorce::facet_zoom which allows to display a vertical zoom on the right side.
#' (and not on the left side as in the facet_zomm function)
#'
#' @param x An expression evaluating to a logical vector that determines the subset of data to zoom in on
#' @param y An expression evaluating to a logical vector that determines the subset of data to zoom in on
#' @param xy An expression evaluating to a logical vector that determines the subset of data to zoom in on
#' @param zoom.data An expression evaluating to a logical vector. If TRUE the data only shows in the zoom panels.
#' If FALSE the data only show in the context panel. If NA the data will show in all panels.
#' @param xlim Specific zoom ranges for each axis. If present they will override x, y, and/or xy.
#' @param ylim Specific zoom ranges for each axis. If present they will override x, y, and/or xy.
#' @param split If both x and y is given, should each axis zoom be shown separately as well? Defaults to FALSE
#' @param horizontal If both x and y is given and split = FALSE How should the zoom panel be positioned
#' relative to the full data panel? Defaults to TRUE
#'
#' @param zoom.size Sets the relative size of the zoom panel to the full data panel. The default
#'  (2) makes the zoom panel twice the size of the full data panel.
#' @param show.area Should the zoom area be drawn below the data points on the full data panel? Defaults to TRUE.
#' @param shrink If TRUE, will shrink scales to fit output of statistics, not raw data.
